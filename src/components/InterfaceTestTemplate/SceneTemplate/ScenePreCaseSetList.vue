<template>
  <div>
    ...
    <scene-pre-case-set-batch-update
      ref="batchUpdate"
      @search="search"
    ></scene-pre-case-set-batch-update>
    <scene-pre-case-set-batch-copy
      ref="batchCopy"
      @search="search"
    ></scene-pre-case-set-batch-copy>
  </div>
...
<script>
import ScenePreCaseSetTab from '../SceneTemplate/ScenePreCaseSetTable';
import ScenePreCaseSetBatchUpdate from '../SceneTemplate/ScenePreCaseSetBatchUpdate';
import ScenePreCaseSetBatchCopy from './ScenePreCaseSetBatchCopy';

import cookies from 'vue-cookies';

export default {
  name: 'ScenePreCaseSetList',
  components: {
    scenePreCaseSetTab: ScenePreCaseSetTab,
    scenePreCaseSetBatchUpdate: ScenePreCaseSetBatchUpdate,
    scenePreCaseSetBatchCopy: ScenePreCaseSetBatchCopy
  },
  data() {
    return {
      // 源host
