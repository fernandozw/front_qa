<template>
  <div>
    ...
    ></element-dialog>
    <backup-element-dialog
      v-if="backupDialogVisible"
      :visible="backupDialogVisible"
      :element-id="elementIdForBackup"
      @listenToChildEventForBackup="callbackFuncForBackup"
    ></backup-element-dialog>
    <el-table
      :data="tableData"
      style="width: 100%"
    ...
    >
      <el-table-column label="id" width="100">
        <template slot-scope="scope">
          <el-tooltip content="点击查看关联的备份元素">
            <el-button
              type="text"
              size="mini"
              @click="clickId(tableData[scope.$index].id)"
            >
...
import BackupElementDialog from '../WebUiTestTemplate/BackupElementDialog';

export default {
  name: 'Element',
  components: {
    elementDialog: ElementDialog,
    backupElementDialog: BackupElementDialog
  },
  data() {
    return {
      elementIdForBackup: null,
